        ...
        <footer>
            <section class="footer-registrate">
                <div class="left-section">
                    ...
                    <p>Regístrate para enterarte de las clases nuevas y los servicios adicionales antes que nadie.<br>
                        Respetamos tu privacidad y nunca compartiremos información con proveedores externos.</p>
                </div>
            ...
            <section class="footer-column-cajon">
                ...
                <div class="footer-column-redes">
                    <svg fill="#254e5f" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid" width="20"
                         height="20"
